...
task autonomous()
{
	...
	case 0:
		...
		TurnRight();
		wait1Msec(400);
		//Rotate Right .40 Secconds
		MoveForward();
		motor[claw] = 107;
		wait1Msec(450);
		//Move Forward .45 Secconds
		TurnLeft();
		motor[claw] = 0;
		wait1Msec(450);
		...
		StopMoving();
		//Stop
		//NEXT TASK: Knock everythin off (say in redneck voice) WOULD U LIKE SOME DELL pEPERSSSSSSSSSs
		MoveBackward();
		wait1Msec(500);
