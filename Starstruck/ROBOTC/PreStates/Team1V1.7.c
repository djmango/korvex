...
#pragma config(Motor,  port8,           catapult1,     tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port9,           catapult2,     tmotorVex393_MC29, openLoop, reversed)
