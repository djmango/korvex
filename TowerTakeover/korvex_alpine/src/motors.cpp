...
// motors
pros::Motor chassisLeftFront(LEFT_MTR1, pros::E_MOTOR_GEARSET_18, false);
pros::Motor chassisLeftBack(LEFT_MTR2, pros::E_MOTOR_GEARSET_18, false);
pros::Motor chassisRightFront(RIGHT_MTR1, pros::E_MOTOR_GEARSET_18, true);
pros::Motor chassisRightBack(RIGHT_MTR2, pros::E_MOTOR_GEARSET_18, true);

pros::Motor liftMotor(LIFT_MTR, pros::E_MOTOR_GEARSET_18, true);
